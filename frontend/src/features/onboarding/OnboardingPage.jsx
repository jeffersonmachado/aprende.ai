...
export default function OnboardingPage() {
  ...
  return (
    <div className="page-stack">
      <h2>Onboarding do aprendiz</h2>
      <p>Defina perfil, meta e estilo para gerar jornada personalizada.</p>
      ...
      <form className="stack-form" onSubmit={handleSubmit}>
        ...
        <label>
          Contexto
          <select value={form.contextType} onChange={(e) => setForm((prev) => ({ ...prev, contextType: e.target.value }))}>
        ...
        <label>
          ...
          <select value={form.experienceLevel} onChange={(e) => setForm((prev) => ({ ...prev, experienceLevel: e.target.value }))}>
        ...
        <label>
          Estilo dominante
          <select value={form.dominantStyle} onChange={(e) => setForm((prev) => ({ ...prev, dominantStyle: e.target.value }))}>
